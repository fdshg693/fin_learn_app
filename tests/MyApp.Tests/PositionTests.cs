...
public class PositionTests
{
    ...
    public void 同じIDの銘柄を足し算すると数量が合算される()
    {
        ...
        var position1 = new Position(instrumentId: "7203", quantity: 100); // トヨタ100株
        var position2 = new Position(instrumentId: "7203", quantity: 50);  // トヨタ50株

        // Act: 足し算する
        var result = position1.Add(position2);

        // Assert: 同じ銘柄として数量が合算されている
        Assert.Equal("7203", result.InstrumentId);
